...
<div class="card card-outline-primary">
    <div class="card-body">
        ...
        <c:if test="${fn:length(UPSList) > 0}">
            <h5 class="card-title">UPS <i class="fas fa-print"></i></h5>
            <jsp:include page="search_field.jsp">
                <jsp:param name="id" value="search_UPS"/>
            </jsp:include>
            <div class="scroll devices_tab_table">
                <table id="UPS_table" class="table table-striped table-bordered" style="width: 2500px;">
                    <thead>
                    ...
                    <tbody id="UPS_table_body">
                    <c:set var="count" value="1"/>
                    <c:forEach items="${UPSList}" var="device">
                        ...
                        <tr class="${edit_device_privilege} UPS link" device-id="${device.id}">
                            <td>${count}</td>
