...
<div class="card card-outline-primary">
    <div class="card-body">
        ...
        <c:if test="${fn:length(DVRList) > 0}">
            <h5 class="card-title">DVR <i class="fas fa-print"></i></h5>
            <jsp:include page="../search_field.jsp">
                <jsp:param name="id" value="search_DVR"/>
            </jsp:include>
            <div class="scroll devices_tab_table">
                <table id="DVR_table" class="table table-striped table-bordered" style="width: 2500px;">
                    <thead>
                    <tr class="table-bordered bg-lightGray">
                        ...
                        <th>Port Number<i class="fas float-left my-2"></i></th>
                        <th>Purchase Date<i class="fas float-left my-2"></i></th>
                        <th>Need To Upgrade<i class="fas float-left my-2"></i></th>
                    </tr>
                    </thead>
                    <tbody id="DVR_table_body">
                    <c:set var="count" value="1"/>
                    <c:forEach items="${DVRList}" var="device">
                        ...
                        <tr class="${edit_device_privilege} DVR link" device-id="${device.id}">
                            <td>${count}</td>
