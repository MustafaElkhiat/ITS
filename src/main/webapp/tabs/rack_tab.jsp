...
<div class="card card-outline-primary">
    <div class="card-body">
        ...
        <c:if test="${fn:length(rackList) > 0}">
            <h5 class="card-title">Rack <i class="fas fa-print"></i></h5>
            <jsp:include page="../search_field.jsp">
                <jsp:param name="id" value="search_rack"/>
            </jsp:include>
            <div class="scroll devices_tab_table">
                <table id="rack_table" class="table table-striped table-bordered" style="width: 2500px;">
                    <thead>
                    ...
                    <tbody id="rack_table_body">
                    <c:set var="count" value="1"/>
                    <c:forEach items="${rackList}" var="device">
