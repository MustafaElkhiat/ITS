    ...
    <div class="card-body">
        ...
        <c:if test="${fn:length(pbxList) > 0}">
            ...
            <div class="scroll devices_tab_table">
                <table id="PBX_table" class="table table-striped table-bordered" style="width: 2500px;">
                    <thead>
                    <tr class="table-bordered bg-lightGray">
                        ...
                        <th>Device Number<i class="fas float-left my-2"></i></th>
                        <th>Purchase Date<i class="fas float-left my-2"></i></th>
                        <th>Need To Upgrade<i class="fas float-left my-2"></i></th>
                    </tr>
                    </thead>
                    <tbody id="PBX_table_body">
                    <c:set var="count" value="1"/>
                    <c:forEach items="${pbxList}" var="device">
