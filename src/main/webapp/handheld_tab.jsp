...
<div class="card card-outline-primary">
    <div class="card-body">
        ...
        <c:if test="${fn:length(handheldList) > 0}">
            <h5 class="card-title">Handheld <i class="fas fa-print"></i></h5>
            <jsp:include page="search_field.jsp">
                <jsp:param name="id" value="search_handheld"/>
            </jsp:include>
            <div class="scroll devices_tab_table">
                <table id="handheld_table" class="table table-striped table-bordered" style="width: 2500px;">
                    <thead>
                    ...
                    <tbody id="handheld_table_body">
                    <c:set var="count" value="1"/>
                    <c:forEach items="${handheldList}" var="device">
