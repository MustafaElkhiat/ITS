...
public class SQLServerHibernateHelper extends HelperBase {


    public SQLServerHibernateHelper(HttpServletRequest request, HttpServletResponse response) {
    ...
    private Session openSession() {
        ...
        session = HibernateUtil.getSQLServerSessionFactory().openSession();
